                ...
                {expenses.length > 0 ? (
                  <div className="space-y-4">
                    {expenses.map((expense) => {
                      ...
                      const driver = typeof expense.driverId === 'object' && expense.driverId?.name 
                        ? expense.driverId 
                        : drivers.find(d => d._id === (
                            typeof expense.driverId === 'object' 
                              ? expense.driverId._id 
                              : expense.driverId
                          ));
                      return (
              ...
              {selectedVehicle.assignedDriverId && (
                <div>
                  ...
                  <p className="text-gray-900">
                    {typeof selectedVehicle.assignedDriverId === 'object' ? 
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {(() => {
                      // Handle both populated and unpopulated driverId
                      if (typeof selectedExpense.driverId === 'object' && selectedExpense.driverId?.name) {
                        return selectedExpense.driverId.name;
                      }
                      // Fallback to finding driver by ID
                      const driver = drivers.find(d => d._id === (
                        typeof selectedExpense.driverId === 'object' 
                          ? selectedExpense.driverId._id 
                          : selectedExpense.driverId
                      ));
