...
interface AddExpenseModalProps {
  ...
  onReceiptUpload: (
    file: File
  ) => Promise<{ ocrData: any; receiptUrl: string }>;
  isCreating?: boolean;
}
        ...
        {isCreating && (
          <div className="absolute inset-0 bg-white bg-opacity-95 flex items-center justify-center z-20 rounded-2xl backdrop-blur-sm">
            <div className="text-center p-8 bg-white rounded-xl shadow-lg">
              ...
              <p className="text-xl text-primary-700 font-bold mt-6">
                {t("modal.creatingExpense")}
              </p>
        ...
        <div className="sticky top-0 bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 text-white p-6 rounded-t-2xl z-10 shadow-lg">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-primary-100 text-xs mt-0.5 ml-7">
              ...
              <div className="space-y-4 animate-fadeIn">
                <div className="text-center mb-6">
                  <h3 className="text-lg font-bold text-gray-900">
                    {t("modal.selectDriverTitle")}
                  </h3>
                  <p className="text-sm text-gray-600 mt-1">
                    {t("modal.selectDriverSubtitle")}
                  </p>
                </div>
                ...
                <div className="max-w-2xl mx-auto">
                  <div className="relative">
                    ...
                    {/* Driver Dropdown */}
                    {showDriverDropdown && (
                      <div className=" z-30 mt-2 w-full bg-white border-2 border-gray-200 rounded-lg shadow-xl max-h-80 overflow-y-auto">
                        {loadingDrivers ? (
                          ...
                          <>
                            ...
                            <div className="px-3 py-2 text-xs text-gray-500 bg-gray-50 border-t">
                              {t("modal.foundDrivers", {
                                count: filteredDrivers.length,
                                plural: filteredDrivers.length !== 1 ? "s" : "",
                              })}
                              {driverSearchQuery &&
                                t("modal.matchingDrivers", {
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-600">
                              {selectedDriverVehicle.licensePlate}
                            </p>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <p className="text-lg font-bold text-blue-600">
                            {selectedDriverVehicle.currentOdometer?.toLocaleString()}{" "}
                            km
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        <span className="text-purple-700 font-semibold">
                          {receiptPreview
                            ? t("modal.changeReceipt")
                            : t("modal.uploadReceipt")}
                        </span>
                      </button>
                      {ocrResult && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <DatePicker
                      ...
                      value={formData.date}
                      onChange={(value) =>
                        setFormData({ ...formData, date: value as string })
                      }
                      label={
                        <>
                          {t("modal.dateLabel")}{" "}
                  ...
                  <div>
                    ...
                    >
                      <option value="">
                        {t("modal.selectCategoryOptional")}
                      </option>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder={
                          selectedDriverVehicle?.currentOdometer?.toString() ||
                          "0"
                        }
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-primary-300 transition-all ${
